odoo.define('web_backend_theme.mobile_menu_tests', function (require) {
"use strict";

var Menu = require('web_backend_theme.Menu');
var testUtils = require('web.test_utils');
var testUtilsEnterprise = require('web_backend_theme.test_utils');
var UserMenu = require('web.UserMenu');

QUnit.module('web_backend_theme mobile_menu_tests', {
    afterEach() {
