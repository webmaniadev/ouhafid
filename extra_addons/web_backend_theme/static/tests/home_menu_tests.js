odoo.define("web_backend_theme.home_menu_tests", function (require) {
    "use strict";

    const HomeMenu = require("web_backend_theme.HomeMenu");
    ...
    QUnit.module("web_backend_theme", {
        beforeEach: function () {
            this.props = {
                apps: [
        ...
        QUnit.test("State reset", async function (assert) {
             ...
             * @see web_backend_theme.WebClient.toggleHomeMenu()
