odoo.define('web_backend_theme.ControlPanel', function (require) {
    "use strict";
     ...
     */
    ControlPanel.patch('web_backend_theme.ControlPanel', T => {
        ...
        ControlPanelPatchEnterprise.template = 'web_backend_theme.ControlPanel';
