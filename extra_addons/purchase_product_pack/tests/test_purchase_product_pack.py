...
class TestPurchaseProductPack(TransactionCase):
    @classmethod
    def setUpClass(cls):
        super(TestPurchaseProductPack, cls).setUpClass()
        # In Odoo 14, DISABLED_MAIL_CONTEXT might not be available in base.tests.common
        # Use the direct dictionary instead
