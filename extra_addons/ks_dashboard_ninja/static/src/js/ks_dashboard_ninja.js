...
//            css_grid = $('.o_rtl').length>0 ?
            ...
            this.ks_date_filter_selections = {
                'l_none': _t('Filtre de date'),
                'l_day': _t('Aujourd hui'),
                't_week': _t('Cette semaine'),
                't_month': _t('Ce mois-ci'),
                't_quarter': _t('Ce trimestre'),
                't_year': _t('Cette année'),
                'n_day': _t('Demain'),
                'n_week': _t('Semaine prochaine'),
                'n_month': _t('Mois prochain'),
                'n_quarter': _t('Trimestre prochain'),
                'n_year': _t('Année prochaine'),
                'ls_day': _t('Hier'),
                'ls_week': _t('Semaine dernière'),
                'ls_month': _t('Mois dernier'),
                'ls_quarter': _t('Trimestre dernier'),
                'ls_year': _t('Année dernière'),
                'l_week': _t('7 derniers jours'),
                'l_month': _t('30 derniers jours'),
                'l_quarter': _t('90 derniers jours'),
                'l_year': _t('365 derniers jours'),
                'ls_past_until_now': _t('Passé jusqu à maintenant'),
                'ls_pastwithout_now': _t('Passé sauf aujourd hui'),
                'n_future_starting_now': _t('A partir de maintenant'),
                'n_futurestarting_tomorrow': _t('A partir de demain'),
                'l_custom': _t('Filtre personnalisé'),
            };
